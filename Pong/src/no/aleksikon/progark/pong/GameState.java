...
public class GameState extends State implements TouchListener, CollisionListener 
{
	...
	private int canvasHeight, canvasWidth, player1Score, player2Score, winner = 0;
	...
	public void draw(Canvas canvas)
	{
		...
		can.drawText("Score player 1: "+player1Score, canvasWidth/2, canvasHeight/2-20, font1);
		can.drawText("Score player 2: "+player2Score, canvasWidth/2, canvasHeight/2+20, font2);
	...
	{
		Log.i("BANG!", "Collision between sprites!");
